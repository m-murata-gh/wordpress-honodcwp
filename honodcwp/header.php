...
if (is_front_page()) {
  ...
  $innerTitle = get_the_title() . ' ｜ ほの歯科クリニック HONO DENTAL CLINIC｜宝殿駅近くの歯医者 - 加古川市米田町';
} else {
  $innerTitle = 'お知らせ | ほの歯科クリニック HONO DENTAL CLINIC｜宝殿駅近くの歯医者 - 加古川市米田町';
}
...
<link rel="stylesheet" href="{$GLOBALS['wproot']}assets/css/main.css">
<link rel="icon" type="image/x-icon" href="{$GLOBALS['wproot']}assets/images/favicon.ico">
<link rel="apple-touch-icon" sizes="180x180" href="{$GLOBALS['wproot']}assets/images/apple-touch-icon.png">
<script defer src="{$GLOBALS['wproot']}assets/js/libs/jquery-3.4.1.min.js"></script>
<script defer src="{$GLOBALS['wproot']}assets/js/libs/smooth-scroll/smooth-scroll.js"></script>
<script defer src="{$GLOBALS['wproot']}assets/js/common.js"></script>
</head>
...
<div class="inner--wide pc-header__inner">
  <div class="logo pc-header__logo"><a href="{$GLOBALS['urlIndex']}"><h1><img src="{$GLOBALS['wproot']}assets/images/logo_navy.svg" alt="ほの歯科クリニック HONO DENTAL CLINIC"></h1></a></div>
  <!-- /.logo -->
  <div class="tel-num pc-header__tel-num"><img src="{$GLOBALS['wproot']}assets/images/tel-num.svg"></div>
  <!-- /.tel-num -->
...
<div class="structure">
  <div class="inner sp-header__inner-1">
    <div class="logo--sm"><a href="{$GLOBALS['wproot']}"><h1><img src="{$GLOBALS['wproot']}assets/images/logo_navy.svg" alt="ほの歯科クリニック HONO DENTAL CLINIC"></h1></a></div>
    <!-- /.logo -->
    <!-- [hmbg-btn] -->
